...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="Meetingsdate_start_date" value="{$fields[$fields.date_start.name].value}" size="11" maxlength="10" title='' tabindex="0" onblur="combo_Meetingsdate_start.update();" onchange="combo_Meetingsdate_start.update(); "    >
